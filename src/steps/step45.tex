...
\begin{minipage}[t]{0.12\textwidth}
    ...
    \begin{tikzpicture}
        \node[anchor=north west] at (0,0) {\usefont{OT1}{phv}{b}{n}\huge 52}; % Numéro de l'étape
    \end{tikzpicture}
\end{minipage}%
\hfill
...
\begin{minipage}[t]{1\textwidth}
    \begin{tcolorbox}[colback=white, colframe=white!60, boxrule=0.7pt, left=2mm, right=2mm, top=1mm, bottom=1mm]
        ...
        \begin{tabularx}{\textwidth}{@{}cc@{\hspace{1cm}}cc@{}}
            \includegraphics[width=1.5cm]{../images/_302_VisM5x14.png} & \textbf{M5 screw} $\times$ 4
            & \includegraphics[width=1.5cm]{../images/_M01_.png} & \textbf{Conveyor cover} $\times$ 1 \\
...
\begin{center}
    \includegraphics[height=8cm]{../images/Couvercle_Convoyeur_1.png}
\end{center}
...
\begin{tcolorbox}[colback=gray!05, colframe=gray!60, boxrule=0.5pt, left=2mm, right=2mm, title=]
    \begin{enumerate}
        \item For conveyor loading only.
