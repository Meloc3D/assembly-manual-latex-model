...
\begin{minipage}[t]{0.12\textwidth}
    ...
    \begin{tikzpicture}
        \node[anchor=north west] at (0,0) {\usefont{OT1}{phv}{b}{n}\huge 30}; % Numéro de l'étape
    \end{tikzpicture}
\end{minipage}%
\hfill
...
\begin{minipage}[t]{1\textwidth}
    \begin{tcolorbox}[colback=white, colframe=white!60, boxrule=0.7pt, left=2mm, right=2mm, top=1mm, bottom=1mm]
        ...
        \begin{tabularx}{\textwidth}{@{}cc@{\hspace{1cm}}cc@{}}
            \includegraphics[width=1.5cm]{../images/_216_Vis à tête fraiséM5x_.png} & \textbf{M5 screw} $\times$ 6
            & \includegraphics[width=1.5cm]{../images/_107_Nut} & \textbf{M5 nut} $\times$ 6
...
\begin{center}
    \includegraphics[height=8cm]{../images/_218_.png}
\end{center}
