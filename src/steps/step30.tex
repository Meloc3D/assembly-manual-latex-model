...
\begin{minipage}[t]{0.12\textwidth}
    ...
    \begin{tikzpicture}
        \node[anchor=north west] at (0,0) {\usefont{OT1}{phv}{b}{n}\huge 37}; % Numéro de l'étape
    \end{tikzpicture}
\end{minipage}%
\hfill
    ...
    \begin{tcolorbox}[colback=white, colframe=white!60, boxrule=0.7pt, left=2mm, right=2mm, top=1mm, bottom=1mm]
        ...
        \begin{tabularx}{\textwidth}{@{}cc@{\hspace{1cm}}cc@{}}
            \includegraphics[width=1.5cm]{../images/_301_VisM5x10.png} & \textbf{M5 Screw} $\times$ 4
             & \includegraphics[width=1.5cm]{../images/_107_Rondele.png} & \textbf{Washer} $\times$ 4 \\
            \includegraphics[width=1.5cm]{../images/_107_Nut.png} & \textbf{M5 nut} $\times$ 4
            %& & \\
            %& \includegraphics[width=1.5cm]{../images/_105_Pied Réglable.png} & \textbf{Pied réglable} $\times$ 4 
...
\begin{center}
    \includegraphics[height=10cm]{../images/_303_.png}
\end{center}
