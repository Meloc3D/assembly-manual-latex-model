...
\begin{minipage}[t]{0.12\textwidth}
    ...
    \begin{tikzpicture}
        \node[anchor=north west] at (0,0) {\usefont{OT1}{phv}{b}{n}\huge 6}; % Numéro de l'étape
    \end{tikzpicture}
\end{minipage}%
\hfill
...
\begin{minipage}[t]{1\textwidth}
    \begin{tcolorbox}[colback=white, colframe=white!60, boxrule=0.7pt, left=2mm, right=2mm, top=1mm, bottom=1mm]
        ...
        \begin{tabularx}{\textwidth}{@{}cc@{\hspace{1cm}}cc@{}}
            \includegraphics[width=1.5cm]{../images/_104_Aile de support Chassis.png} & \textbf{Chassis support wing} $\times$ 1
            %& \includegraphics[width=1.5cm]{../images/_107_Rondele.png} & \textbf{Rondelle} $\times$ 4 \\
            %\includegraphics[width=1.5cm]{../images/_107_Nut.png} & \textbf{Ecrou M5} $\times$ 4
            %& & \\
        \end{tabularx}
...
\begin{center}
    \includegraphics[height=10cm]{../images/_106_.png}
\end{center}
